      ...
      describe "videos" do
        ...
        describe "create" do
          ...
          context "duplicate" do
            before(:each) { FactoryGirl.create(:video, :title => "UniqueTitle") }
        ...
        describe "edit" do
          before(:each) { FactoryGirl.create(:video, :title => "A title") }
        ...
        describe "destroy" do
          before(:each) { FactoryGirl.create(:video, :title => "UniqueTitleOne") }
